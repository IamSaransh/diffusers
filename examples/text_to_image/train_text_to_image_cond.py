...
CLASS_NAMES = ['Tomato mosaic virus','Tomato Leaf Mold', 'Pepper bell Bacterial spot','Potato Early blight', 'Potato Late blight' ,
            'Tomato Early blight', 'Tomato healthy', 'Tomato Late blight',  'Pepper bell healthy','Tomato YellowLeaf Curl Virus', 
...
def log_validation(vae, text_encoder, tokenizer, unet, args, accelerator, weight_dtype, epoch):
    ...
    for i in range(len(args.validation_prompts)):
        ...
        with autocast_ctx:
            ...
            print(class_label)
            image = pipeline(args.validation_prompts[i], height=args.resolution, width = args.resolution,  num_inference_steps=50, generator=generator, class_label_idx = class_label).images[0]
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                model_pred = unet(noisy_latents, timesteps, encoder_hidden_states,class_labels =    class_label_indices, return_dict=False)[0]
